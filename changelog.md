...
## [3.2.0] - 06-08-2023
### Added
* [Added `getTermsVector` to SearchBuilder and Client](https://cbelasticsearch.ortusbooks.com/searching/search#term-vectors) to allow for fetching term vectors on document field(s)
