	...
	accessors="true"
{
    ...
    public function populate( struct properties ){
        ...
        if( arguments.keyExists( "properties" ) ){
            ...
            variables.startTime = dateAdd( 's', taskProperties.start_time_in_millis / 1000, epochDate );
            variables.runningTime = dateDiff( 's', dateAdd( 'l', taskProperties.running_time_in_nanos / 1000000, variables.startTime ), variables.startTime  );
        }
