component {
    ...
    public void function install(){
        ...
        if( !isReady() ){
            wirebox.getInstance( "IndexBuilder@cbelasticsearch" ).new(
    ...
    private void function logMigration( string direction, string componentName ){
        if( arguments.direction == "down" ){
            variables.wirebox.getInstance( "Client@cbelasticsearch" ).deleteByQuery(
                wirebox.getInstance( "SearchBuilder@cbelasticsearch" )
            ...
            wirebox.getInstance( "Document@cbelasticsearch" ).new(
    ...
    public void function runSeed( required string invocationPath ) {
        ...
        var searchClient = wirebox.getInstance( "Client@cbelasticsearch" );
        invoke( seeder, "run", [ searchClient, wirebox.getInstance( "MockData@mockdatacfc" ) ] );
    }
