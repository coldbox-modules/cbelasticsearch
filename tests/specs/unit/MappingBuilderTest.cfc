		...
		describe( "MappingBuilder", function(){
			...
			describe( "property types", function(){
				it( "text", function(){
					...
					var expected = { "full_name" : { "type" : "text" } };
				...
				it( "keyword", function(){
					...
					var expected = { "tags" : { "type" : "keyword" } };
				...
				it( "integer", function(){
					...
					var expected = { "bytes" : { "type" : "integer" } };
				...
				it( "double", function(){
					...
					var expected = { "discount" : { "type" : "double" } };
				...
				it( "halfFloat", function(){
					...
					var expected = { "proprtion" : { "type" : "half_float" } };
				...
				it( "scaledFloat", function(){
					...
					var expected = { "price" : { "type" : "scaled_float", "scaling_factor" : 100 } };
				...
				it( "date", function(){
					...
					var expected = { "createdDate" : { "type" : "date" } };
				...
				it( "strictDate", function(){
					...
					var expected = { "publishedDate" : { "type" : "date", "format" : "strict_date" } };
				...
				it( "boolean", function(){
					...
					var expected = { "isSubscribed" : { "type" : "boolean" } };
				...
				it( "integerRange", function(){
					...
					var expected = { "expectedAtendees" : { "type" : "integer_range" } };
				...
				it( "floatRange", function(){
					...
					var expected = { "standardDeviation" : { "type" : "float_range" } };
				...
				it( "longRange", function(){
					...
					var expected = { "averageViews" : { "type" : "long_range" } };
				...
				it( "doubleRange", function(){
					...
					var expected = { "over_under" : { "type" : "double_range" } };
				...
				it( "dateRange", function(){
					...
					var expected = { "timeframe" : { "type" : "date_range" } };
				...
				it( "ipRange", function(){
					...
					var expected = { "ip_allowlist" : { "type" : "ip_range" } };
				...
				it( "geoPoint", function(){
					...
					var expected = { "location" : { "type" : "geo_point" } };
				...
				it( "geoShape", function(){
					...
					var expected = { "location" : { "type" : "geo_shape" } };
				...
				it( "ip", function(){
					...
					var expected = { "ip_address" : { "type" : "ip" } };
				...
				it( "completion", function(){
					...
					var expected = { "suggest" : { "type" : "completion" } };
				...
				it( "tokenCount", function(){
					...
					var expected = { "length" : { "type" : "token_count" } };
				...
				it( "percolator", function(){
					...
					var expected = { "query" : { "type" : "percolator" } };
			...
			describe( "parameters", function(){
				it( "forwards on further method calls as parameters", function(){
					...
					var expected = { "full_name" : { "type" : "text", "index" : false } };
				...
				it( "converts camelCase to snake_case", function(){
					var actual = builder.create( function( mapping ){
						mapping.text( "full_name" ).indexPrefixes( { "min_chars" : 1, "max_chars" : 10 } );
					} );
				...
				it( "can add a single parameter", function(){
					var actual = builder.create( function( mapping ){
						mapping
							.text( "full_name" )
							.addParameter( "index_prefixes", { "min_chars" : 1, "max_chars" : 10 } );
					} );
